...
//  export function createScatterGLContext(selectors) {
 ...
 export class Camera {
   ...
   drawResult(hand) {
     if (hand.keypoints != null) {
       const wristCoords=[hand.keypoints3D[0].x.toFixed(3),
       hand.keypoints3D[0].y.toFixed(3),hand.keypoints3D[0].z.toFixed(3)]
       console.log('wrist',wristCoords)
